...
export default function EditarAccionable({
  ...
  const confirmarEliminar = () => {
    Alert.alert(
      "Eliminar Accionable",
      `¿Estás seguro de que quieres eliminar "${tituloAccionable}"?`,
      [
      ...
      <View style={styles.centeredView}>
        <View style={styles.modalView}>
          <View style={styles.modalHeader}>
            <Text style={styles.modalLabel}>Editar accionable</Text>
          ...
          <View style={styles.botoneraModal}>
            <Pressable
              style={[styles.btnModal, { backgroundColor: "rgba(54, 109, 192, 1)" }]}
            ...
            <Pressable
              style={[styles.btnModal, { backgroundColor: "rgba(192, 54, 54, 1)" }]}
              onPress={onClose}
            >
